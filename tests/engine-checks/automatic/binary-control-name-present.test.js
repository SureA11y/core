...
test(`${RULE_ID}: fixture coverage (tests/fixtures/binary-control-name-present-all-scenarios.html)`, () => {
  const fixturePath = path.join(__dirname, '../..', 'fixtures', 'binary-control-name-present-all-scenarios.html');
  ...
  const expectedFailIds = [
    'binctl_case_01', 'binctl_case_07', 'binctl_case_10', 'binctl_case_13', 'binctl_case_15', 'binctl_case_17', 'binctl_case_19', 'binctl_case_18b', 'binctl_case_23'
  ];

  const expectedNoOccIds = [
    'binctl_case_02', 'binctl_case_03', 'binctl_case_04', 'binctl_case_05', 'binctl_case_06', 'binctl_case_08', 'binctl_case_09', 'binctl_case_11', 'binctl_case_12', 'binctl_case_14', 'binctl_case_16', 'binctl_case_18', 'binctl_case_20', 'binctl_case_21', 'binctl_case_22', 'binctl_case_24', 'binctl_case_25'
  ];
