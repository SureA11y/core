...
test('textbox-name-present: wrapping <label> has its own aria-label even though its only child content is aria-hidden (found on a real site)', () => {
...
test(`${RULE_ID}: fixture coverage (tests/fixtures/textbox-name-present-all-scenarios.html)`, () => {
  const fixturePath = path.join(__dirname, '../..', 'fixtures', 'textbox-name-present-all-scenarios.html');
  ...
  const expectedFailIds = [
    'textbox_case_01', 'textbox_case_02', 'textbox_case_08', 'textbox_case_09', 'textbox_case_10', 'textbox_case_12', 'textbox_case_13', 'textbox_case_17'
  ];
