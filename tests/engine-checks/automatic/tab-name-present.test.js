...
test(`${RULE_ID}: fixture coverage (tests/fixtures/tab-name-present-all-scenarios.html)`, () => {
  const fixturePath = path.join(__dirname, '../..', 'fixtures', 'tab-name-present-all-scenarios.html');
  ...
  const expectedFailIds = [
    'tab_case_01', 'tab_case_06', 'tab_case_07', 'tab_case_08', 'tab_case_09', 'tab_case_11', 'tab_case_15'
  ];

  const expectedNoOccIds = [
    'tab_case_02', 'tab_case_03', 'tab_case_04', 'tab_case_05', 'tab_case_10', 'tab_case_12', 'tab_case_13', 'tab_case_14', 'tab_case_16', 'tab_case_17'
  ];
