...
test(`${RULE_ID}: fixture coverage (tests/fixtures/form-control-programmatic-label-all-scenarios.html)`, () => {
    const fixturePath = path.join(__dirname, '../..', 'fixtures', 'form-control-programmatic-label-all-scenarios.html');
    ...
    const expectedNoOccIds = [
        ...
        'fc_case_33','fc_case_34','fc_case_35','fc_case_36',

        // Aggregation demo-only
        'fc_case_39b','fc_case_39c','fc_case_40',
    ];
