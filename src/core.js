...
const RULE_IMPLS = {
  "a11yCore-area-alt-present": require("./rules/area-alt-present.js").runInPage,
  "a11yCore-canvas-text-alternative": require("./rules/canvas-text-alternative.js").runInPage,
  "a11yCore-form-control-accessible-name": require("./rules/form-control-accessible-name.js").runInPage,
  "a11yCore-form-control-explicit-label": require("./rules/form-control-explicit-label.js").runInPage,
  "a11yCore-img-alt-attr-present": require("./rules/img-alt-attr-present.js").runInPage,
  "a11yCore-img-alt-empty": require("./rules/img-alt-empty.js").runInPage,
  "a11yCore-img-alt-functional-name": require("./rules/img-alt-functional-name.js").runInPage,
  "a11yCore-input-image-accessible-name": require("./rules/input-image-accessible-name.js").runInPage,
  "a11yCore-links-target-blank-noopener": require("./rules/links-target-blank-noopener.js").runInPage,
  "a11yCore-nontext-equivalent-alternative-manual": require("./rules/nontext-equivalent-alternative-manual.js").runInPage,
  "a11yCore-svg-role-img-name": require("./rules/svg-role-img-name.js").runInPage,
  "manual-review": require("./rules/manual-review.js").runInPage
};
